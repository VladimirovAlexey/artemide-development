...
call uTMDFF_Initialize('TMDFF.atmde',prefix='Prog/LargeX/INI/')
call TMDR_Initialize('TMDFF.atmde',prefix='Prog/LargeX/INI/')

!!! Setup parameters of CS kernel (see
call TMDR_SetNPparameters((/1.5d0, 0.0369d0, 0.0582d0, 0.d0/))

call uTMDFF_SetLambdaNP((/0d0, 0d0, 0d0, 0d0, 0.0d0, 0d0, 0.d0, 0d0/))

OPEN(UNIT=51, FILE="/data/WorkingFiles/TMD/Fit_Notes/LargeX/Data/uTMDFF_LO", ACTION="write", STATUS="replace")
