...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  real*8, dimension(1:NUM) :: xx, xxLP, xxKPC
...
write(*,*) " Result---->>:"
    do i = 1, NUM
      ...
      write(*,'("{", F8.2,", ", F16.12,"},")')Q(i), xx(i)! Q(i), xx(i)
...
!------------------------------------------------------------------------
!                    LP cross section at qT = 0
!------------------------------------------------------------------------
!   write(*,*) "LP xSec at qT=0", xx(i)
