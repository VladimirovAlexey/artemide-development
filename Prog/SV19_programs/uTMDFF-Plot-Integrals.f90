...
real*8,parameter::xValues(1:15)=(/0.1d0,0.15d0,0.2d0,0.25d0,0.3d0,0.35d0,0.4d0,&
0.45d0,0.5d0,0.55d0,0.6d0,0.65d0,0.7d0,0.75d0,0.8d0/)
...
call uTMDFF_SetLambdaNP(NParray(11:14),.false.,.false.)
