...
character(*),parameter::repFILE=prefix//'Replicas/AdditionalCases/SV19_nnlo_all=0_piK.rep'
character(*),parameter::constFILE=&
'/home/vla18041/LinkData2/arTeMiDe_Repository/artemide/Prog/SV19_programs/const-DY+SIDIS_NNPDF31+DSS_nnlo+KT+piK'
...
call uTMDFF_SetLambdaNP(NParray(10:17),.true.,.false.)
