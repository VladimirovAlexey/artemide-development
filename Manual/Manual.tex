...
\\\hline \hline
2001 & $\delta_{ff'}|e_f|^2$~~&$f_1$ & $d_1$ & (unpol)$h_1+\gamma\to h_2$ & no & LP
\\\hline \hline
2002 & $\delta_{ff'}|e_f|^2$~~&$f^{d}_1$ & $d_1$ & (unpol)$d^{(h_1)}+\gamma\to h_2$. Here, $d^{(h_1)}$ is the isoscalar target prepared from the hadron $h_1$. I.e. $u,d\to (u+d)/2$. For $h_1$=proton, this simulates the deuteron target. & no & LP
\\\hline \hline
2003 & $\delta_{f\bar f'}|e_f|^2$~~&$f^{n}_1$ & $d_1$ & (unpol)$n^{(h_1)}+\gamma\to h_2$ Here, $n^{(h_1)}$ is the iso-conjugated target prepared from the hadron $h_1$. I.e. $u\leftrightarrow d$. For $h_1$=proton, this simulates the neutron target. & no & LP
\\\hline \hline
2101 & $\delta_{ff'}|e_f|^2$~~&$f_1$ & $d^{h_{1+2}}_1$ & (unpol)$h_1+\gamma\to h_{1+2}$, where $h_{1+2}=1+2$. Computed strictly with produced hadron 1 and 2 (accounts only the sign of $h_2$ argument). & no & LP
\\\hline
2102 & $\delta_{ff'}|e_f|^2$~~&$f_1$ & $d^{h_{1+2+3}}_1$ & (unpol)$h_1+\gamma\to h_{1+2+3}$, where $h_{1+2+3}=1+2+3$  Computed strictly with produced hadron 1, 2 and 3 (accounts only the sign of $h_2$ argument). & no & LP
\\\hline
2103 & $\delta_{ff'}|e_f|^2$~~&$f^d_1$ & $d^{h_{1+2}}_1$ & (unpol)$d^{(h_1)}+\gamma\to h_{1+2}$, where $h_{1+2}=1+2$ and d is isoscalar target $u,d\to (u+d)/2$.  Computed strictly with produced hadron 1 and 2 (accounts only the sign of $h_2$ argument). & no & LP
\\\hline
2104 & $\delta_{ff'}|e_f|^2$~~&$f^d_1$ & $d^{h_{1+2+3}}_1$ & (unpol)$d^{(h_1)}+\gamma\to h_{1+2+3}$, where $h_{1+2+3}=1+2+3$ and d is isoscalar target $u,d\to (u+d)/2$.  Computed strictly with produced hadron 1, 2 and 3 (accounts only the sign of $h_2$ argument). & no & LP
\\\hline
2105 & $\delta_{ff'}|e_f|^2$~~&$f^n_1$ & $d^{h_{1+2}}_1$ & (unpol)$n^{(h_1)}+\gamma\to h_{1+2}$, where $h_{1+2}=1+2$ and n is neutron target $(u\leftrightarrow d)$.  Computed strictly with produced hadron 1 and 2 (accounts only the sign of $h_2$ argument). & no & LP
\\\hline
2106 & $\delta_{ff'}|e_f|^2$~~&$f^n_1$ & $d^{h_{1+2+3}}_1$ & (unpol)$n^{(h_1)}+\gamma\to h_{1+2+3}$, where $h_{1+2+3}=1+2+3$ and n is neutron target $(u\leftrightarrow d)$.  Computed strictly with produced hadron 1, 2 and 3 (accounts only the sign of $h_2$ argument). & no & LP
\\\hline\hline
\end{longtable}
...
\\\hline
200 & $(X_{20}+X_{30})/X_2$ & -- & 1 & Angular coefficient $A_0$
\\\hline
201 & $(X_{21}+X_{31})/X_2$ & -- & 1 & Angular coefficient $A_1$
\\\hline
202 & $(X_{22}+X_{32})/X_2$ & -- & 1 & Angular coefficient $A_2$
\\\hline
203 & $X_{23}/X_2$ & -- & 1 & Angular coefficient $A_3$
\\\hline
204 & $X_{24}/X_2$ & -- & 1 & Angular coefficient $A_4$
\\\hline
205 & $X_{35}/X_2$ & -- & 1 & Angular coefficient $A_5$
\\\hline
206 & $X_{36}/X_2$ & -- & 1 & Angular coefficient $A_6$
\\\hline
210 & $1-2(X_{20}+X_{30})/(X_{29}+\frac{1}{2}X_{30})$ & -- & 1 & Angular coefficient $\lambda$
\\\hline
211 & $(X_{21}+X_{31})/(X_{29}+\frac{1}{2}X_{30})$ & -- & 1 & Angular coefficient $\mu$
\\\hline
212 & $(X_{22}+X_{32})/(X_{29}+\frac{1}{2}X_{30})$ & -- & 1 & Angular coefficient $\nu$
\\\hline\hline
\multicolumn{5}{||l||}{* The processes 200-299 are reserved for ratios. No common prefactors are included.}
\\
\multicolumn{5}{||l||}{* $X_n$ denotes the cross-section for corresponding \texttt{N}.}
\end{longtable}
