...
\item For \texttt{SiversTMDPDF}, \texttt{BoerMuldersTMDPDF} the convolution is twist-3. The section C, is absence since it is not yet implemented.
\end{itemize}
...
\\\hline\hline
\texttt{XX\_lowScale5(x,bT,h)} & real(-5:5) & Returns the value of TMD distributions for given (x,b) (reals) and hadron h. The value is the vector over flavors. For $h<0$ the quark-distributions are replaced by anti-quark distributions and vice versa. I.e. $F(-h)=F(h)(5:-5:-1)$
\\\hline\hline
\end{tabular}
\end{center}
...
\\\hline
5 & $1+\frac{\tau^2}{2Q^2}(-1+S^2-\Lambda)$ & $ \Delta^{GG'} z^{GG'}_{+\ell}z^{GG'}_{+f} f_1 f_1$(\blue{$=F_1$}) & $\mathcal{P}_2$ & Z-boson term $\sim \mathcal{P}_3$
\\\hline
...
\\\hline
12 & $-\frac{\tau^3S}{4M^2Q^2q_T}(Q^2(-1+S^2-\Lambda)+2\tau^2 \Lambda)$ & $ i\Delta^{GG'} z^{GG'}_{+\ell}r^{GG'}_{-f} \{h^\perp_1 h^\perp_1\}_A$(\blue{$=F_{11}$}) & $\mathcal{P}_4$ & Z-boson term $\sim \mathcal{P}_4$
\\\hline\hline
...
\\\hline
35 & \scalebox{0.7}{$-\frac{\tau^3\sqrt{\Lambda}}{4M^2Qq_T^2}(Q^2(1+S^2-\Lambda)+\tau^2(-1+S^2+\Lambda))$} & $ i\Delta^{GG'} z^{GG'}_{+\ell}r^{GG'}_{-f} \{h^\perp_1 h^\perp_1\}$(\blue{$=F_{11}$}) & 1 & $h_1h_1$ part of angular coefficient $A_5$
\\\hline
36 & $-\frac{\tau^3S}{4M^2Q^2q_T}(Q^2(-1+S^2-\Lambda)+2\Lambda\tau^2)$ & $ i\Delta^{GG'} z^{GG'}_{+\ell}r^{GG'}_{-f} \{h^\perp_1 h^\perp_1\}$(\blue{$=F_{11}$}) & 1 & $h_1h_1$ part of angular coefficient $A_6$
\\\hline\hline
\end{longtable}
...
\item $\tilde b=b$
\item $\tilde c$ is replaced by the $c$ $h_1$, $h_2$ according to the following table
\end{itemize}
\begin{center}
List of available commands
\\
...
4 & [2,1,-1] & $p+\bar p\to Z$ &
\\\hline
5 & [3,1,1] & $p+p\to Z+\gamma$ &
\\\hline
6 & [3,1,-1] & $p+\bar p\to Z+\gamma$ &
\\\hline
7 & [4,1,1] & $p+p\to W^+$ &
\\\hline
8 & [5,1,1] & $p+p\to W^-$ &
...
9 & [6,1,1] & $p+p\to W^\pm$ &
\\\hline
10 & [4,1,-1] & $p+\bar p\to W^+$ &
\\\hline
11 & [5,1,-1] & $p+\bar p\to W^-$ &
\\\hline
12 & [6,1,-1] & $p+\bar p\to W^\pm$ &
\\\hline
13 & [7,1,1] & $p+p\to W^+$ & Same as 7 with $\Gamma_W=0$
\\\hline
14 & [8,1,1] & $p+p\to W^-$ & Same as 8 with $\Gamma_W=0$
\\\hline
15 & [9,1,1] & $p+p\to W^\pm$ & Same as 9 with $\Gamma_W=0$
\\\hline
16 & [7,1,-1] & $p+\bar p\to W^+$ & Same as 9 with $\Gamma_W=0$
\\\hline
17 & [8,1,-1] & $p+\bar p\to W^-$ & Same as 10 with $\Gamma_W=0$
\\\hline
18 & [9,1,-1] & $p+\bar p\to W^\pm$ & Same as 11 with $\Gamma_W=0$
\\\hline
20 & [10,1,1] & $p+p\to H$ &
\\\hline
21 & [11,1,1] & $p+p\to H$ & Only $f_1$
\\\hline
22 & [12,1,1] & $p+p\to H$ & Only $f_1^\perp$
\\\hline
101 & [1,2,1] & $\pi^-+p\to \gamma$ &
\\\hline
102 & [1,2,-1] & $\pi^-+\bar p\to \gamma$ &
\\\hline
103 & [1,-2,1] & $\pi^++p\to \gamma$ &
\\\hline
104 & [1,-2,-1] & $\pi^++\bar p\to \gamma$ &
\\\hline
1001 & [101,1,1] & $p+Cu\to \gamma$ & 
\\\hline
1002 & [102,1,1] & $p+^2H\to \gamma$ & 
\\\hline
1003 & [103,-1,1] & $\bar p+W\to \gamma$ & 
\\\hline
1004 & [103,2,1] & $\pi^-+W\to \gamma$ & 
\\\hline\hline
 SIDIS
\\\hline\hline
