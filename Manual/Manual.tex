...
\\\hline
10102 & $\delta_{f f'}|e_f|^2$ & $-(f_{1T}^\perp)^{\bar p}$ & $f_1$ & (Sivers)$\bar p+h\to\gamma$(with $h=2$) & no
\\\hline
10103 & $\delta_{f f'}|e_f|^2$ & $-(f_{1T}^\perp)^{p}$ & $f_1$ & (Sivers)$p+\bar h\to\gamma$(with $h=2$). Note, that it is equal 10102 & no
\\\hline
...
\\\hline\hline
1204N & $\delta_{ff'}|e_f|^2$~~&$(f_{1T}^\perp)^d$ & $d^{h_N}_1$ & (Sivers)$d^{\uparrow}+\gamma\to h_N$, for $N=\{1,...,9\}$, n is neutron target $n=p(u\leftrightarrow d)$. & no
\\\hline
1205N & $\delta_{ff'}|e_f|^2$~~&$(f_{1T}^\perp)^d$ & $d^{\bar h_N}_1$ & (Sivers)$d^{\uparrow}+\gamma\to \bar h_N$, for $N=\{1,...,9\}$, n is neutron target $n=p(u\leftrightarrow d)$. & no
\\\hline \hline
...
\\\cline{2-3} & \textbf{\blue{Same with \texttt{lpTMDPDF}}} &
\\\cline{2-3} & \textbf{\blue{Same with \texttt{SiverTMDPDF}}} &
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\\\hline
...
\begin{itemize}
	...
	\item \textbf{harpy} Added functions for values of uTMDFF, lpTMDPDF, SiverTMDPDF, and DNP.
