...
\end{center}
\begin{itemize}
\item \texttt{wgtTMDPDF} has extra section F and G, which are analogous to sections B and C, but responsible for twist-3 convolution. The section F is correspondingly section H.
\end{itemize}
