...
The module is practically the same as \texttt{uTMDPFF}. Command are the same as for \texttt{uTMDPDF} with replacement \texttt{uTMDPDF\_...} to \texttt{lpTMDPDF\_...}. The NNLO coefficient functions used in the module were evaluated in \cite{Gutierrez-Reyes:2019rug} (please, cite it if use).
...
19998 &  &  &  &  & 
\\\hline \hline
12001 & $\delta_{ff'}|e_f|^2$~~&$(f_{1T}^\perp)^p$ & $d^{h_1}_1$ & (Sivers)$p+\gamma\to h_1$ & no
\\\hline
1200N & $\delta_{ff'}|e_f|^2$~~&$(f_{1T}^\perp)^p$ & $d^{h_N}_1$ & (Sivers)$p+\gamma\to h_N$, for $N=\{1,...,9\}$ (including case 2001) & no
\\\hline \hline
12011 & $\delta_{ff'}|e_f|^2$~~&$(f_{1T}^\perp)^{d}$ & $d^{h_1}_1$ & (Sivers)$d+\gamma\to h_1$. Here, d is isoscalar target $(p+n)/2$. & no
\\\hline
1201N & $\delta_{ff'}|e_f|^2$~~&$(f_{1T}^\perp)^{d}$ & $d^{h_N}_1$ & (Sivers)$d+\gamma\to h_N$, for $N=\{1,...,9\}$ (including case 2011). Here, d is isoscalar target $(p+n)/2$. & no
\\\hline \hline
12021 & $\delta_{f\bar f'}|e_f|^2$~~&$(f_{1T}^\perp)^p$ & $d^{\bar h_1}_1$ & (Sivers)$p+\gamma\to \bar h_1$ & no
\\\hline
1202N & $\delta_{f\bar f'}|e_f|^2$~~&$(f_{1T}^\perp)^p$ & $d^{\bar h_N}_1$ & (Sivers)$p+\gamma\to \bar h_N$, for $N=\{1,...,9\}$ (including case 2021) & no
\\\hline \hline
12031 & $\delta_{f\bar f'}|e_f|^2$~~&$(f_{1T}^\perp)^{d}$ & $d^{\bar h_1}_1$ & (Sivers)$d+\gamma\to \bar h_1$. Here, d is isoscalar target $(p+n)/2$. & no
\\\hline
1203N & $\delta_{f\bar f'}|e_f|^2$~~&$(f_{1T}^\perp)^{d}$ & $d^{\bar h_N}_1$ & (Sivers)$d+\gamma\to \bar h_N$, for $N=\{1,...,9\}$ (including case 2031). Here, d is isoscalar target $(p+n)/2$. & no
\\\hline\hline
\end{tabular}
\\
...
\item[\textbf{Ver.2.05}]
\begin{itemize}
	\item \textbf{TMDF} Added processes for Sivers 12001--12039.
...
\begin{itemize}
\item Add $\epsilon$ or mW algorithm for Hankel integrals (see Lukas,Stone,Evaluating infinite integrals involving Bessel ...)
\item Fix over-computation issue in bin-integration routines for extremely small bins.
\item Fix large-$\mathcal{D}$ asymptotic for NNNLO exact $\zeta$-line.
\end{itemize}
