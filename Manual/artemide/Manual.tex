...
\item \textbf{aTMDe\_integration} which defines elementary integration routines. Specific integrations (such as the Hankel transform) are made specially in corresponding modules.
\item \textbf{aTMDe\_invMatrix} which defines the operation of matrix inverse.
\end{itemize}
