...
\begin{itemize}
\item The specification of the kinematical point is done by the \texttt{type(DYpoint)}, see section \ref{sec:aTMDE_ptSpec}.
...
\item The flag \texttt{exactX1X2} (INI section \texttt{*9/*A}) controls how $x_1$ and $x_2$ are computed in the LP version of the factorization. These values correspond
\begin{eqnarray}
...
\item The flag \texttt{exactZeta} (INI section \texttt{*9/*A}) controls the definition of $\zeta$-scale in the LP version of factorization. 
\begin{eqnarray}
