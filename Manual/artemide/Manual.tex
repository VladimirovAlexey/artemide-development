...
\begin{itemize}
	...
	\item Many external codes are re-integrated in the form of classes. These are \textbf{Fourier, Moment, Fourier\_byOgata}  (unified in the new module \textbf{aTMDe\_Ogata}), \textbf{Twist2\_ChGrid} (reintroduced in the new module \textbf{aTMDe\_optGrid}). Corresponding corrections in interfaces are made in all dependent modules.
