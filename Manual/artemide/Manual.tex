...
\begin{itemize}
	...
	\item \blue{Integration with \textbf{snowflake}}: snowflake code is now part of distribution of the artemide. It is not required for functioning of the artemide code (in general), but could be used. It has few files and is compiled alongside with artemide.
\end{itemize}
\item[\textbf{Ver.3.01}]
\begin{itemize}
