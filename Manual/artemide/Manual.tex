...
However, this algorithms works well only in the vicinity of $q_T$-peak, so it is limited to the $q_T$-bins in the range $q_T<q_{T,MAX}$, where $q_{T,MAX}$ is specified in the constants file.
