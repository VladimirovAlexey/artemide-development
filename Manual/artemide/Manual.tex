...
This module evaluates cross-sections with the SIDIS-like kinematics. I.e. it expects the following kinematic input, $(s,Q,x,z)$ which defines the variables $x$'s, etc.
...
\\\hline
\texttt{xSec\_SIDIS} &subrout. &\ref{TMDXs:xsec} & Evaluates cross-section completely integrated over the bin. 
\\\hline
\texttt{xSec\_SIDIS\_List} &subrout. &\ref{TMDXs:xsec} & Evaluates cross-section completely integrated over the bin over the list. 
\\\hline\hline
\end{tabular}
\end{center}
\begin{tcolorbox}
