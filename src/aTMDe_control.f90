...
subroutine artemide_SetScaleVariations(c1,c2,c3,c4)
    ...
    if(include_wgtTMDPDF) call wgtTMDPDF_SetScaleVariation_tw2(c4)
    if(include_wgtTMDPDF) call wgtTMDPDF_SetScaleVariation_tw3(c4)
    if(include_wglTMDPDF) call wglTMDPDF_SetScaleVariation_tw2(c4)
    if(include_wglTMDPDF) call wglTMDPDF_SetScaleVariation_tw3(c4)
