...
function parametrizationStringAt1(z)
    ...
    parametrizationStringAt1=(/0d0,0d0,0d0,(1d0-z)*(Log(1d0-z)-1d0)/)
...
subroutine Set_Coeff_q_g(alpha,Nf,Lmu)  
    ...
    Coeff_q_g=(/0d0/)
    if(order_global>=1) then
        Coeff_q_g=Coeff_q_g+alpha*(/-2d0*Lm+1d0, 2d0*Lmu-1d0, -Lmu+0.5d0/)
    end if
...
>>>>>>> 162b7bdfccb8d409946779ab55695bc9a8ae69ca
